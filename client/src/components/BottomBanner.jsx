...
import { Truck, Leaf, Coins, ShieldCheck, Sparkles } from 'lucide-react'

const iconMap = {
  'Fastest Delivery': Truck,
  'Freshness Guaranteed': Leaf,
  'Affordable Prices': Coins,
  'Trusted by Thousands': ShieldCheck,
}
            ...
            {features.map((feature, index)=>(
                <div key={index} className='flex items-center gap-4 mt-2'>
                    {(() => {
                      ...
                      return <Icon className='md:w-11 w-9 h-9 md:h-11 text-primary' />
                    })()}
                    <div>
